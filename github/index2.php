...
$sql = "SELECT id, title, start, end, color FROM events2 ";
...
<ul class="parent">
    ...
    <li><a href="#" ><i class="fa fa-clock-o" aria-hidden="true" ></i> Liste des personnels</a></li>
    <li><a href="../ajout_perso.php" ><i class="fa fa-plus" aria-hidden="true"></i> Ajouter un personnel</a></li>
    <li><a href="index2.php"><i class="fa fa-calendar-check-o" aria-hidden="true" ></i> Agenda</a>
