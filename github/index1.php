...
$sql = "SELECT id, title, start, end, color FROM events1 ";
...
<nav >
<ul class="parent">
        <li><a href="../index_ges.php" style="text-decoration:none" ><i class="fa fa-home" aria-hidden="true"></i> Accueil</a></li>
        <li><a href="../pdf/index.php" style="text-decoration:none"><i class="fa fa-clone" aria-hidden="true"></i>Listes des Demandes </a></li>
        <li><a href="../pdf/histo_ges.php" style="text-decoration:none"><i class="fa fa-clock-o" aria-hidden="true" ></i> Historique</a></li>
        <li><a href="index1.php"style="text-decoration:none" ><i class="fa fa-calendar-check-o" aria-hidden="true" ></i> Agenda</a>
